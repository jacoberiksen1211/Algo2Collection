...
public class KMP_Mandatory2 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numGroundPhases; i++) {
            ...
            int[] tempGroundTrick = new int[tempGroundTrickString.length];
       ...
       /* System.out.println("track:");
        ...
        System.out.println("");
        System.out.println("groundtricks:");
        for (int i = 0; i < groundTricks.length; i++) {
            for (int j = 0; j < groundTricks[i].length; j++) {
                System.out.print(groundTricks[i][j] + " ");
            }
            System.out.println(" ");
        }*/

        //generate faillinks
        int[][] failLinks = new int[numGroundPhases][];
        //for each pattern
        for (int x = 0; x < numGroundPhases; x++) {
        ...
        //print faillinks
        /*System.out.println("faillinks:");
        for (int i = 0; i < failLinks.length; i++) {
            for (int j = 0; j < failLinks[i].length; j++) {
                System.out.print(failLinks[i][j] + " ");
            }
            System.out.println("");
        }*/
        ...
        while(textIndex < track.length){
            ...
            if(track[textIndex] == groundTricks[patternToMatch][patternIndex]){
                ...
                if(patternIndex == groundTricks[patternToMatch].length){
                    ...
                    patternIndex = 0;
                    //if all patterns matched (success) then go back to look for another last pattern
                    if(patternToMatch == groundTricks.length ){
